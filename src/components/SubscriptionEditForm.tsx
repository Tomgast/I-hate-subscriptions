...
import { SUBSCRIPTION_CATEGORIES, BILLING_CYCLES, Subscription } from '@/types/subscription'
...
export function SubscriptionEditForm({ subscription, onSuccess, onCancel }: SubscriptionEditFormProps) {
  ...
  const {
    ...
    defaultValues: {
      ...
      nextBillingDate: subscription.nextBillingDate.split('T')[0], // Convert to date format
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <select {...register('category')} className="input-field">
              {Object.entries(SUBSCRIPTION_CATEGORIES).map(([value, { label }]) => (
