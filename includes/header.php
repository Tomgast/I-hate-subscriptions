        ...
        <div class="flex justify-between items-center h-16">
            <div class="flex items-center space-x-3">
                <a href="<?php echo $logoLink; ?>" class="flex items-center space-x-2 hover:scale-105 transition-transform duration-200" <?php echo $logoOnClick; ?>>
                    <img src="<?php echo $pathPrefix; ?>assets/images/logo.svg" alt="CashControl" class="h-8">
                </a>
            </div>
            
            <?php if (!$isLoggedIn): ?>
            <div class="hidden md:flex items-center space-x-8">
                <a href="<?php echo $pathPrefix; ?>index.html#features" class="text-gray-600 hover:text-green-600 font-medium transition-colors duration-200 relative group">
                    Features
                    <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-green-500 group-hover:w-full transition-all duration-200"></span>
                </a>
                <a href="<?php echo $pathPrefix; ?>index.html#pricing" class="text-gray-600 hover:text-green-600 font-medium transition-colors duration-200 relative group">
                    Pricing
                    <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-green-500 group-hover:w-full transition-all duration-200"></span>
                </a>
                <a href="<?php echo $pathPrefix; ?>demo.php" class="text-gray-600 hover:text-green-600 font-medium transition-colors duration-200 relative group <?php echo $currentPage === 'demo' ? 'text-green-600' : ''; ?>">
                    Demo
            ...
            <?php else: ?>
            <div class="hidden md:flex items-center space-x-8">
                <a href="<?php echo $pathPrefix; ?>index.html" class="text-gray-600 hover:text-green-600 font-medium transition-colors duration-200 relative group <?php echo $currentPage === 'index' ? 'text-green-600' : ''; ?>">
                    Home
                ...
                <a href="<?php echo $pathPrefix; ?>dashboard.php" class="text-gray-600 hover:text-green-600 font-medium transition-colors duration-200 relative group <?php echo $currentPage === 'dashboard' ? 'text-green-600' : ''; ?>">
                    Dashboard
                ...
                <a href="<?php echo $pathPrefix; ?>settings.php" class="text-gray-600 hover:text-green-600 font-medium transition-colors duration-200 relative group <?php echo $currentPage === 'settings' ? 'text-green-600' : ''; ?>">
                    Settings
                ...
                <a href="<?php echo $pathPrefix; ?>upgrade.php" class="text-gray-600 hover:text-green-600 font-medium transition-colors duration-200 relative group <?php echo $currentPage === 'upgrade' ? 'text-green-600' : ''; ?>">
                    Upgrade
