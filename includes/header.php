...
$logoLink = $isLoggedIn ? 'dashboard.php' : 'index.html';
        ...
        <div class="flex justify-between items-center h-16">
            <div class="flex items-center space-x-3">
                <a href="<?php echo $logoLink; ?>" class="flex items-center space-x-2 hover:scale-105 transition-transform duration-200" <?php echo $logoOnClick; ?>>
                    <img src="<?php echo $isLoggedIn ? '' : ''; ?>assets/images/logo.svg" alt="CashControl" class="h-8">
                </a>
            </div>
            
            <?php if (!$isLoggedIn): ?>
            <div class="hidden md:flex items-center space-x-8">
                <a href="index.html#features" class="text-gray-600 hover:text-green-600 font-medium transition-colors duration-200 relative group">
                    Features
                    <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-green-500 group-hover:w-full transition-all duration-200"></span>
                </a>
                <a href="index.html#pricing" class="text-gray-600 hover:text-green-600 font-medium transition-colors duration-200 relative group">
                    Pricing
                    <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-green-500 group-hover:w-full transition-all duration-200"></span>
                </a>
